...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: 'The world\'s tallest residential clock tower, Franck Muller Aeternitas by London Gate, offers an unparalleled luxury lifestyle in Dubai Marina.',
    highlights: ['World\'s Tallest Clock Tower', 'Franck Muller Branded', 'Marina & Sea Views', 'Ultra-Luxury Living'],
    amenities: ['Private Cinema', 'Zen Garden', 'Infinity Pool', 'Spa & Wellness', 'Concierge'],
    gallery: ['https://images.unsplash.com/photo-1582650625119-3a31f8fa2699?auto=format&fit=crop&q=80&w=800'],
    heroImage: 'https://images.unsplash.com/photo-1582650625119-3a31f8fa2699?auto=format&fit=crop&q=80&w=1200'
  },
  {
    id: 19,
    developerId: 3,
    ...
    handover: 'Q4 2027',
    paymentPlan: '80/20 Payment Plan',
    description: 'Damac Casa is a water-inspired luxury tower in Al Sufouh, offering breathtaking views of the Palm Jumeirah and the Arabian Gulf.',
    highlights: ['Water-Inspired Design', 'Palm Jumeirah Views', 'Private Pools', 'Prime Location'],
    amenities: ['Aqua Spa', 'Artificial Beach', 'Floating Cabanas', 'Sky Garden'],
    gallery: ['https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&q=80&w=800'],
    heroImage: 'https://images.unsplash.com/photo-1512917774080-9991f1c4c750?auto=format&fit=crop&q=80&w=1200'
  },
  {
    ...
    location: 'Dubailand',
    type: 'Villa',
    price: 'Starting AED 8,500,000',
    handover: 'Q2 2028',
    paymentPlan: '90/10 Payment Plan',
    description: 'The Oasis by Emaar is a luxury resort-style community featuring stunning mansions and villas surrounded by water and lush greenery.',
    highlights: ['Resort-Style Living', 'Waterfront Villas', 'Lush Greenery', 'Emaar Quality'],
    amenities: ['Lagoons', 'Community Center', 'Parks', 'Wellness Center'],
    gallery: ['https://images.unsplash.com/photo-1613490493576-7fde63acd811?auto=format&fit=crop&q=80&w=800'],
    heroImage: 'https://images.unsplash.com/photo-1613490493576-7fde63acd811?auto=format&fit=crop&q=80&w=1200'
  },
  {
    ...
    location: 'Motor City',
    type: 'Apartment',
    price: 'Starting AED 985,000',
    handover: 'Q4 2027',
    paymentPlan: '80/20 Payment Plan',
    description: 'Sobha Orbis offers a sophisticated urban lifestyle in Motor City, with modern design and premium finishes.',
    highlights: ['Urban Sophistication', 'Premium Finishes', 'High ROI', 'Vibrant Community'],
    amenities: ['Swimming Pool', 'Gym', 'Retail Outlets', 'Landscaped Gardens'],
    gallery: ['https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=800'],
    heroImage: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=1200'
  },
  {
    ...
    location: 'Dubai Creek Harbour',
    type: 'Apartment',
    price: 'Starting AED 1,700,000',
    handover: 'Q2 2028',
    paymentPlan: '90/10 Payment Plan',
    description: 'Aeon at Dubai Creek Harbour is a modern residential development offering a blend of urban living and natural beauty.',
    highlights: ['Creek Views', 'Modern Design', 'Waterfront Living', 'Sustainable Community'],
    amenities: ['Infinity Pool', 'Fitness Center', 'Waterfront Promenade', 'Parks'],
    gallery: ['https://images.unsplash.com/photo-1600607687940-47a0f9259d4b?auto=format&fit=crop&q=80&w=800'],
    heroImage: 'https://images.unsplash.com/photo-1600607687940-47a0f9259d4b?auto=format&fit=crop&q=80&w=1200'
  },
  {
    ...
    location: 'Sheikh Zayed Road',
    type: 'Apartment',
    price: 'Starting AED 1,670,000',
    handover: 'Q1 2028',
    paymentPlan: '80/20 Payment Plan',
    description: 'Volta by DAMAC is a fitness-inspired residential tower on Sheikh Zayed Road, designed for those who embrace an active lifestyle.',
    highlights: ['Fitness-Inspired Design', 'Prime SZR Location', 'Luxury Amenities', 'High ROI'],
    amenities: ['Sky Pool', 'Boxing Ring', 'Climbing Wall', 'Yoga Deck'],
    gallery: ['https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=800'],
    heroImage: 'https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?auto=format&fit=crop&q=80&w=1200'
  },
  {
    ...
    location: 'Business Bay',
    type: 'Apartment',
    price: 'Starting AED 1,250,000',
    handover: 'Q4 2027',
    paymentPlan: '80/20 Payment Plan',
    description: 'Canal Heights by DAMAC offers chic waterfront living in Business Bay, inspired by the brilliance of blue pearls.',
    highlights: ['Waterfront Living', 'Business Bay Hub', 'Chic Interiors', 'Canal Views'],
    amenities: ['Underwater Pearl Museum', 'Shell-Inspired Pool', 'Gym', 'Retail'],
    gallery: ['https://images.unsplash.com/photo-1549944850-84e00be4203b?q=80&w=800'],
    heroImage: 'https://images.unsplash.com/photo-1549944850-84e00be4203b?q=80&w=1200'
  },
  {
    id: 25,
    developerId: 1,
    ...
    handover: 'Q4 2026',
    paymentPlan: '80/20 Payment Plan',
    description: 'Emaar South is a flagship community in Dubai South, offering a mix of tiered townhouses and villas near the Al Maktoum International Airport.',
    highlights: ['Near Al Maktoum Airport', 'Golf Course Community', 'High Rental Yield', 'Emaar Master Plan'],
    amenities: ['Golf Course', 'Community Center', 'Parks', 'Retail'],
    gallery: ['https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=800'],
  ...
  },
  {
    ...
    handover: 'Q4 2026',
    paymentPlan: '60/40 Payment Plan',
    description: 'Sobha 1 is a stunning residential development in MBR City, featuring five interconnected towers with world-class amenities.',
    highlights: ['MBR City Location', 'Golf Course Views', 'Sky Gardens', 'Luxury Finishes'],
    amenities: ['Pitch & Putt Golf', 'Sky Terrace', 'Gym', 'Pool'],
    gallery: ['https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?q=80&w=800'],
    heroImage: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?q=80&w=1200'
  },
  {
    id: 27,
    developerId: 5,
    ...
    location: 'Business Bay',
    type: 'Apartment',
    price: 'Starting AED 1,400,000',
    handover: 'Q4 2027',
    paymentPlan: '70/30 Payment Plan',
    description: 'Binghatti Skyrise is a modern architectural masterpiece in Business Bay, offering luxury apartments with stunning canal views.',
    highlights: ['Business Bay Hub', 'Canal Views', 'Iconic Design', 'High ROI'],
    amenities: ['Infinity Pool', 'Gym', 'Retail', 'Concierge'],
  ...
  },
  {
    ...
    location: 'Meydan',
    type: 'Apartment',
    price: 'Starting AED 950,000',
    handover: 'Ready & Off-Plan',
    paymentPlan: 'Flexible Plans',
    description: 'Azizi Riviera is a French Mediterranean-inspired community in Meydan, offering a vibrant lifestyle with a stunning crystal lagoon.',
    highlights: ['Crystal Lagoon', 'Meydan Location', 'French Riviera Vibe', 'High Rental Demand'],
    amenities: ['Beach Access', 'Retail Boulevard', 'Parks', 'Gym'],
    gallery: ['https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?q=80&w=800'],
    heroImage: 'https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?q=80&w=1200'
  }
];
